...
class TransactionsManager {
    ...
    Create(name, type, agent, date, referenceDate, value, description, details) {
        ...
        try {
            ...
            const transaction = new transaction_1.Transaction(newId, currentDate, currentDate, name, description, transactionType, agent, date, referenceDate, value, details || "");
