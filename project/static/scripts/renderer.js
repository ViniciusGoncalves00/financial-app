...
.hover\\:border-neutral_0:hover {
  --tw-border-opacity: 1;
  border-color: rgba(255, 255, 255, var(--tw-border-opacity, 1));
}

.hover\\:border-neutral_9:hover {
  --tw-border-opacity: 1;
  border-color: rgba(30, 30, 30, var(--tw-border-opacity, 1));
}
...
.hover\\:border-r-\\[px\\]:hover {
  border-right-color: px;
}
