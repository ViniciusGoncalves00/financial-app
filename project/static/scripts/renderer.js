    ...
    Read() {
        try {
            ...
            for (let i = 0; i < records.length; i++) {
                const transaction = new transaction_1.Transaction(records[i].name, records[i].description, records[i].type, records[i].agent, parseInt(records[i].transactionDate), parseInt(records[i].referenceDate), parseFloat(records[i].value), records[i].details || "", records[i].id, parseInt(records[i].creationDate), parseInt(records[i].lastModified));
                this._transactions.push(transaction);
            }
        }
        catch (error) {
